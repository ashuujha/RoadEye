...
does not contact a map, tile, model, or analytics service.
...
frame. Plate-string search is intentionally absent until the independent Indian
ANPR phase produces real OCR output.
